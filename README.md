# Android QPST Tool for Qualcomm Snapdragon 865 devices [ROOT]  
An Android application which has various features for fixing baseband etc. problems on Qualcomm Snapdragon 865 devices.  
